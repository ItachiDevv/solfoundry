...
class DisputeHistoryDB(Base):
    """Represents a dispute history d b."""
...
class DisputeListItem(BaseModel):
    """Represents a dispute list item."""
    id: str
    bounty_id: str
    submitter_id: str
    reason: str
...
class DisputeListResponse(BaseModel):
    """Represents a dispute list response."""
...
class DisputeHistoryItem(BaseModel):
    """Represents a dispute history item."""
    id: str
    dispute_id: str
    action: str
...
class DisputeDetailResponse(DisputeResponse):
    """Represents a dispute detail response."""
    history: List[DisputeHistoryItem] = []


class DisputeStats(BaseModel):
    """Represents a dispute stats."""
