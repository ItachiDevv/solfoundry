...
class TestSearchParamsValidation:
    """Tests for search params validation."""
...
class TestBountySearchService:
    """Tests for bounty search service."""
    @pytest.mark.asyncio
